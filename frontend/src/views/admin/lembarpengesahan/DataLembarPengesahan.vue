            ...
            >
              ...
              <td class="px-6 py-4 text-right">
                ...
                <div v-else class="flex items-center justify-end gap-2">
                  ...
                  >
                    <span v-if="previewing === item.id" class="animate-spin rounded-full h-3.5 w-3.5 border-b-2 border-current"></span>
                    <span v-else class="material-symbols-outlined text-[16px]">visibility</span>
                    Lihat
                  </button>
                  <button
