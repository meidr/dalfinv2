...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\skripsi\backend\public\storage' => 'string',
            ...
            'services.simkeu.base_url' => 'string',
            'services.simkeu.api_key' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\skripsi\\backend\\public\\storage','logging.default',
...
'services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.simkeu.base_url','services.simkeu.api_key','session.driver',
...
'signed','throttle','verified','role','log.activity',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','skripsi.index','skripsi.store',
'skripsi.show','skripsi.update','skripsi.destroy','fakultas.index','fakultas.store','fakultas.show',
'fakultas.update','fakultas.destroy','prodi.index','prodi.store','prodi.show',
'prodi.update','prodi.destroy','tahun.index','tahun.store','tahun.show',
'tahun.update','tahun.destroy','jabatan.index','jabatan.store','jabatan.show',
'jabatan.update','jabatan.destroy',
'seminar.index','seminar.store','seminar.show','seminar.update','seminar.destroy','dokumen.index',
'dokumen.store','dokumen.show','dokumen.update','dokumen.destroy','periode-jabatan.index','periode-jabatan.store',
'periode-jabatan.show','periode-jabatan.update','periode-jabatan.destroy','jabatan-pejabat.index','jabatan-pejabat.store',
'jabatan-pejabat.show','jabatan-pejabat.update','jabatan-pejabat.destroy','tanda-tangan.index',
'tanda-tangan.store','tanda-tangan.show','tanda-tangan.update','tanda-tangan.destroy','storage.local',);
        registerArgumentsSet('views', 
'pdf.berita-acara-seminar','pdf.jadwal-ujian','pdf.nota-bimbingan','pdf.rekap-yudisium','pdf.sk-penguji',
'pdf.sk-tugas','pdf.sk-yudisium','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.laragon.www.skripsi.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'VITE_APP_NAME','SIMKEU_URL','SIMKEU_API_KEY',);
